...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 07 Bulan Mei 2024 pada 02.47
...
(5, 'Dr. Robert', 'L', 'Semarang', '1985-12-05', 'Anastesi', '085678901234', 'Semarang', 3),
(21, 'Yossy Indra Kusuma', 'L', 'Depok SMart city', '2024-05-06', 'Umum', '081211462862', 'Bogay', 5);
...
(5, '2024-02-04', 75, 180, '135/88', 'Perlu pemantauan lebih lanjut', 5, 1);
...
(110223073, 'yossykusuma01@gmail.com', '86', 'yossykusuma01@gmail.com', '2024-04-22 07:59:15');
...
--
ALTER TABLE `users`
  MODIFY `user_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=110223074;
